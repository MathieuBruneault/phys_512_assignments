...
def find_wave(event_name, fname_H, fname_L, template_name):
    ...
    #Get a (very) rough estimate of positional uncertainty using time difference, a distance of 1000km between detectors and the speed of light
    time_diff=np.abs(params_H[2]-params_L[2])
    dist=1000*1000
    error_estimate=c*time_diff/dist
    print('For this event I would expect an uncertainty on the position angle of about ' + str(error_estimate) + ' degrees')
